...
const { findAll, findOne, addNew, drop, bidItem, getOwnItems, closeBid, rejectBid, setTopListing } = require('../controllers/productCtrl.js')
...
productRouter.put('/topList/:productid', setTopListing)
productRouter.put('/bid/:productid/with/:collateralid', bidItem)
productRouter.put('/closeBid/:productid/with/:collateralid', authorization, closeBid)
